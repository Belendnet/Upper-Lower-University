 ...
 */
class LabeledStackView(posX: Number, posY: Number, label: String = "", height: Number, width: Number) :
    CardStack<CardView>(height = height, width = width, posX = posX, posY = posY) {
